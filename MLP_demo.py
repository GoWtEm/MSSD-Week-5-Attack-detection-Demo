...
plt.subplot(3,1,2)
plt.plot(lit101,label="LIT101")
plt.xlabel('Time(Secs)')
plt.ylabel('LIT101')
plt.legend()

plt.subplot(3,1,3)
plt.plot(p101,label="P101")
plt.xlabel('Time(Secs)')
plt.ylabel('Status')
plt.legend()
...
plt.plot(Y_valid, label="Actual LIT101")
plt.plot(Pred_valid, label="Predicted LIT101")
plt.legend()

# Show the "Safety Zone" (the red dotted lines)
plt.subplot(2, 1, 2)
plt.plot(error_valid, label="Error")
plt.axhline(y=upper_thresh, color='r', linestyle='--', label="Upper Threshold")
plt.axhline(y=lower_thresh, color='r', linestyle='--', label="Lower Threshold")
...
plt.figure(figsize=(10, 8))
plt.subplot(2, 1, 1)
plt.title("Testing - Normal Operation")
plt.plot(Y_normal, label="Actual LIT101")
plt.plot(Pred_normal, label="Predicted LIT101")
plt.legend()

plt.subplot(2, 1, 2)
plt.plot(error_normal, label="Error")
plt.axhline(y=upper_thresh, color='r', linestyle='--',label="Upper Threshold")
plt.axhline(y=lower_thresh, color='r', linestyle='--', label="Lower Threshold")
plt.legend()
...
plt.figure(figsize=(10, 8))
plt.subplot(2, 1, 1)
plt.title("Testing - Attack")
plt.plot(Y_test_attack, label="Actual LIT101")
plt.plot(Pred_normal, label="Predicted LIT101")
plt.legend()

# Notice how the error line now crashes through the Red Dotted Safety Limits!
plt.subplot(2, 1, 2)
plt.plot(error_attack, label="Error")
plt.axhline(y=upper_thresh, color='r', linestyle='--',label="Upper Threshold")
plt.axhline(y=lower_thresh, color='r', linestyle='--', label="Lower Threshold")
plt.xlabel('Time (Seconds)')
plt.ylabel('Error ')
