...
### Overview
This project demonstrates two different methodologies for detecting anomalies in Cyber-Physical Systems (CPS). We specifically focus on the **LIT101** sensor (Water Level Indicator) from a standard CPS dataset.
